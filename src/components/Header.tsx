...
const Header = () => {
  ...
  return (
    <div className={'w-full bg-gray-100 text-slate-700 dark:bg-slate-900 dark:text-slate-50 z-50'}>
      <header
        className={`w-4/5 mx-auto flex flex-col md:flex-row items-center justify-between h-28 transform transition duration-200 ease-in ${
          pastHeader ? 'fixed top-0 w-full px-32 max-h-16 bg-slate-900' : 'h-28'
        }`}
      >
        <div>
